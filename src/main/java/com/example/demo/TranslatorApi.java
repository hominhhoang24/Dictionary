...
public class TranslatorApi {
    ...
    private static String translate(String langFrom, String langTo, String text)
            throws IOException {
        String urlStr =
                "https://script.google.com/macros/s/AKfycbyLSW5YGQtohRQPDM377XEG4NaD0jEMbW-PoDNypAt2Gtjd7RaJnS0dDxS587ohme8d/exec"
                        + "?q="
        ...
        if (responseCode != HttpURLConnection.HTTP_OK) {
            throw new IOException("Failed to get response, HTTP code: " + responseCode);
        }
        BufferedReader in =
                new BufferedReader(
